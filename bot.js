...
function generateMessages(){
    ...
    for (let role of roles) messages.push(`<:SL:528604903094878209> Abboniere das Interessengebiet **"${role}"** durch einen klick auf die unten aufgeführte Reaktion!`); //DONT CHANGE THIS
    return messages;
}
